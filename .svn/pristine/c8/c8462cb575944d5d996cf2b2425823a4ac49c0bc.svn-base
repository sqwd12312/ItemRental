...
<div class="admin-content-body">
	<div class="am-cf am-padding am-padding-bottom-0">
		<div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">物品更新</strong><small></small></div>
    </div>
	<hr>
</div>
<div class="result-content">
        <form action="zukeUpdateItem.action" method="post" id="myform" name="myform" enctype="multipart/form-data" >
                    <table class="insert-tab" width="100%">
                    <input type="hidden" name="itemId" value="${item.itemId}"/>
                        <tbody>
                            <tr>
                                <th><i class="require-red">*</i>物品编号：</th>
                                <td><input class="common-text" name="itemNumber" value="${item.itemNumber }" id="name" size="50" type="text" readonly></td>
                            </tr>                                
                            <tr>
