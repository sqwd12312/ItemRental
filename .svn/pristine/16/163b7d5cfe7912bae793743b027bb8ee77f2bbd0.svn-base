...
<div class="admin-content-body">
	<div class="am-cf am-padding am-padding-bottom-0">
		<div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">物品评价</strong><small></small></div>
    </div>
	<hr>
</div>
	<form id="houseForm" name="houseForm"
		action="getItemEvaluationsByAdmin.action"
		method=post >
							...
							<tbody>
								...
								<c:forEach items="${evaluationList}" var="evaluation">
									<tr
										...
										<td>${evaluation.zukeId}</td>																												
										<td><fmt:formatDate value="${evaluation.time}" pattern="yyyy-MM-dd hh:mm:ss"/></td>
										<td>
											<a class="link-update"										
											href="deleteEvalutionByAdmin.action?id=${evaluation.id}"
