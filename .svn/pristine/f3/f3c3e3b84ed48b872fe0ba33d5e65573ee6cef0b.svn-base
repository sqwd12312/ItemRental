...
public void setZuKeId(String zuKeId) {
	this.zuKeId = zuKeId;
}
public String getChuZuId() {
	return chuZuId;
}
public void setChuZuId(String chuZuId) {
