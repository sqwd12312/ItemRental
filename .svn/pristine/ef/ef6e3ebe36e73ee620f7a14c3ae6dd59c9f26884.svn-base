...
<div class="search-wrap">
            <div class="search-content">
                <form action="paid/getAllPaidBackRent.action" method="post" name="myform">
                    <table class="search-tab">
                        <tr>
                            <th width="120">租客Id：</th>
                            <td><input class="common-text" placeholder="租客Id" name="zukeId" value="${vo.zukeId }" id="zukeId" type="text"></td>
                            <th width="70">起始日期:</th>
								...
								<c:forEach items="${queryPaids}" var="paid">
									<tr
										...
										<td>
													...
													<a class="link-update"
											href="paid/deletePayBack.action?payId=${paid.paid.id}"
