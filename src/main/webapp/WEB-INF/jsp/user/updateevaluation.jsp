...
<div class="admin-content-body">
	<div class="am-cf am-padding am-padding-bottom-0">
		<div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">更新物品评价</strong><small></small></div>
    </div>
	<hr>
</div>
<div class="result-content">
        <form action="userUpdateEvaluation.action" method="post" id="myform" name="myform" enctype="multipart/form-data" >
                        ...
                        <tbody>
                           ...
                           <tr>
                            ...
                            <tr>
                                ...
                                <td><input class="common-text" name="itemName" value="${itemName}" id="name" size="50" type="text" readonly></td>
                            </tr>
                            <tr>
