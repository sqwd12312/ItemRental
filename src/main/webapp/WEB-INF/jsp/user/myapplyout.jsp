...
<div class="admin-content-body">
	<div class="am-cf am-padding am-padding-bottom-0">
		<div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">退租申请列表</strong><small></small></div>
    </div>
	<hr>
</div>
			...
			<div class="result-content">
				<table id=grid class="result-tab" width="100%">
					<tbody>
						...
						<c:forEach items="${ApplyoutList}" varStatus="i" var="list">
							<tr
								style="FONT-WEIGHT: normal; FONT-STYLE: normal; BACKGROUND-COLOR: white; TEXT-DECORATION: none">							
									...
									<td>${list.masterPhone}</td>
									<td><B style="color:red">${list.status}</B></td>
									<td><c:if test="${list.status!='申请中'}">
											<a class="link-update"
												href="applyout/deleteapplyout.action?aoId=${list.id}"
