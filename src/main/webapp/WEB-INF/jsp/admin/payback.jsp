...
<div class="admin-content-body">
	<div class="am-cf am-padding am-padding-bottom-0">
		<div class="am-fl am-cf"><strong class="am-text-primary am-text-lg">已退回租金列表</strong><small></small></div>
    </div>
	<hr>
</div>
<div class="search-wrap">
            <div class="search-content">
                <form action="getAllPaidBackRent.action" method="post" name="myform">
                    <table class="search-tab">
                        <tr>
                            <th width="100">租客Id：</th>
								...
								<c:forEach items="${queryPaids}" var="paid">
									<tr
										...
										<td>
													...
													<a class="link-update"
											href="deletePayBack.action?payId=${paid.paid.id}"
